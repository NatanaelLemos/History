...
namespace History
{
    public partial class frmMap : SILIB.View.frmMain
    {
        ...
        public frmMap()
        {
            ...
            InitializeComponent();
            btnConfiguracoes.Renderer = new ConfigRenderer();
        ...
        private void SelectPaisUnderMouse()
        {
            ...
            switch (_MapNumber)
            {
                case 0:
                    ...
                    {
                        case "fffd5764":
                            cmbPais.Text = "Reino da Inglaterra";
                            break;
                        case "ffacfdd0":
                            cmbPais.Text = "Reino da França";
                            break;
                        case "ffebf291":
                            cmbPais.Text = "Reino da Espanha";
                            break;
                        case "fff28e8c":
                            cmbPais.Text = "Reino de Portugal";
                            break;
                        case "fff291e0":
                            cmbPais.Text = "Sacro Império Romano Germânico";
                            break;
                    }
                    break;
                case 1:
    ...
    internal sealed class ConfigRenderer : ToolStripProfessionalRenderer
    {
        public ConfigRenderer() : base(new ConfigColors()) { }
    }

    internal sealed class ConfigColors : ProfessionalColorTable
    {
        public override Color MenuItemPressedGradientBegin
        {
            get
            {
                return Color.FromArgb(30, 80, 120);
            }
        }
